...
def main() -> None:
    """
    Einsstsiegsfunktion, die die ETL-Pipeline ausführt: EXTRACT->TRANSFORMATION->LOAD
    """

    # 1. Daten extrahieren aus einer CSV-Datei
    raw_rows = extract_csv(
         DATA_PATH / "sensors.csv"
    )
    # print(next(raw_rows, "End"))
    # nicht konsumieren
    # print(list(raw_rows))
...
def test() -> None:
    ...
    Test Datei
    """
    raw_rows = open(DATA_PATH / "sensors.csv")
    print("file:", raw_rows)
    raw_rows.close()
